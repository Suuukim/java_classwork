...
public class JT02 extends JFrame {
	...
	private void init() {
		Album jt02 = AlbumDao.selectAlbum("TWICE", "JT02");
		File music = new File("D:\\프로젝트 자료\\src\\music_file\\TWICE 2집-I CAN’T STOP ME.wav");

		// 재생 음악 타이틀
		JLabel title = new JLabel(jt02.getT_song());
...
//		title.setForeground(Color.WHITE);
		...
		ImageIcon playPause_pic = new ImageIcon(JT02.class.getResource("../image_files/playpause.png"));
		...
		ImageIcon pause_pic = new ImageIcon(JT02.class.getResource("../image_files/stop.png"));
		...
		volume.setBackground(MainPage.twice_color);
		...
		ImageIcon alb_pic = new ImageIcon(JT02.class.getResource("../image_files/twice_2.jpg"));
		...
		JLabel team_name = new JLabel(jt02.getTeam_name());
...
//		team_name.setForeground(Color.WHITE);
		...
		JLabel alb_name = new JLabel(jt02.getAlb_name());
...
//		alb_name.setForeground(Color.WHITE);
		...
		JLabel song_cnt = new JLabel(String.format("%d", jt02.getSong_cnt()));
...
//		song_cnt.setForeground(Color.WHITE);
		...
		JLabel t_song = new JLabel(jt02.getT_song());
...
//		t_song.setForeground(Color.WHITE);
		...
		JLabel s_date = new JLabel(String.format("%s", jt02.getS_date()));
...
//		s_date.setForeground(Color.WHITE);
		...
		info.setLayout(null);
		info.setBackground(MainPage.twice_color);
