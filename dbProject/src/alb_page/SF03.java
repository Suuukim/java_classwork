...
public class SF03 extends JFrame {
	...
	private void init() {
		Album sf03 = AlbumDao.selectAlbum("f(x)", "SF03");
		File music = new File("D:\\프로젝트 자료\\src\\music_file\\f(x) 3집-Red Light.wav");

		// 재생 음악 타이틀
		JLabel title = new JLabel(sf03.getT_song());
...
//		title.setForeground(Color.WHITE);
		...
		ImageIcon playPause_pic = new ImageIcon(SF03.class.getResource("../image_files/playpause.png"));
		...
		ImageIcon pause_pic = new ImageIcon(SF03.class.getResource("../image_files/stop.png"));
		...
		ImageIcon alb_pic = new ImageIcon(SF03.class.getResource("../image_files/fx_3.jpg"));
		...
		JLabel team_name = new JLabel(sf03.getTeam_name());
...
//		team_name.setForeground(Color.WHITE);
		...
		JLabel alb_name = new JLabel(sf03.getAlb_name());
...
//		alb_name.setForeground(Color.WHITE);
		...
		JLabel song_cnt = new JLabel(String.format("%d", sf03.getSong_cnt()));
...
//		song_cnt.setForeground(Color.WHITE);
		...
		JLabel t_song = new JLabel(sf03.getT_song());
...
//		t_song.setForeground(Color.WHITE);
		...
		JLabel s_date = new JLabel(String.format("%s", sf03.getS_date()));
