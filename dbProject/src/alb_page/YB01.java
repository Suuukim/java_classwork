...
public class YB01 extends JFrame {
	...
	private void init() {
		Album yb01 = AlbumDao.selectAlbum("BLACKPINK", "YB01");
		File music = new File("D:\\프로젝트 자료\\src\\music_file\\Blackpink 1집-Lovesick Grils.wav");

		// 재생 음악 타이틀
		JLabel title = new JLabel(yb01.getT_song());
		title.setFont(new Font("맑은 고딕", Font.BOLD, 30));
//		title.setForeground(Color.WHITE);
		title.setBounds(600, 130, 400, 40);

		// 음악 재생&일시정지
		JButton playPause = new JButton();
		ImageIcon playPause_pic = new ImageIcon(YB01.class.getResource("../image_files/playpause.png"));
		...
		ImageIcon pause_pic = new ImageIcon(YB01.class.getResource("../image_files/stop.png"));
		...
		volume.setBackground(MainPage.blpink_color);
		...
		ImageIcon alb_pic = new ImageIcon(YB01.class.getResource("../image_files/black_1.jpg"));
		image.setIcon(alb_pic);
		image.setBounds(140, 50, 303, 350);
		...
		JLabel team_name = new JLabel(yb01.getTeam_name());
...
//		team_name.setForeground(Color.WHITE);
		...
		JLabel alb_name = new JLabel(yb01.getAlb_name());
...
//		alb_name.setForeground(Color.WHITE);
		...
		JLabel song_cnt = new JLabel(String.format("%d", yb01.getSong_cnt()));
...
//		song_cnt.setForeground(Color.WHITE);
		...
		JLabel t_song = new JLabel(yb01.getT_song());
...
//		t_song.setForeground(Color.WHITE);
		...
		JLabel s_date = new JLabel(String.format("%s", yb01.getS_date()));
...
//		s_date.setForeground(Color.WHITE);
		...
		info.setLayout(null);
		info.setBackground(MainPage.blpink_color);
