...
public class JT01 extends JFrame {
	...
	private void init() {
		Album jt01 = AlbumDao.selectAlbum("TWICE", "JT01");
		File music = new File("D:\\프로젝트 자료\\src\\music_file\\TWICE 1집-LIKEY.wav");

		// 재생 음악 타이틀
		JLabel title = new JLabel(jt01.getT_song());
...
//		title.setForeground(Color.WHITE);
		...
		ImageIcon playPause_pic = new ImageIcon(JT01.class.getResource("../image_files/playpause.png"));
		...
		ImageIcon pause_pic = new ImageIcon(JT01.class.getResource("../image_files/stop.png"));
		...
		ImageIcon alb_pic = new ImageIcon(JT01.class.getResource("../image_files/twice_1.jpg"));
		...
		JLabel team_name = new JLabel(jt01.getTeam_name());
...
//		team_name.setForeground(Color.WHITE);
		...
		JLabel alb_name = new JLabel(jt01.getAlb_name());
...
//		alb_name.setForeground(Color.WHITE);
		...
		JLabel song_cnt = new JLabel(String.format("%d", jt01.getSong_cnt()));
...
//		song_cnt.setForeground(Color.WHITE);
		...
		JLabel t_song = new JLabel(jt01.getT_song());
...
//		t_song.setForeground(Color.WHITE);
		...
		JLabel s_date = new JLabel(String.format("%s", jt01.getS_date()));
