...
public class JM02 extends JFrame {
	...
	private void init() {
		Album jm02 = AlbumDao.selectAlbum("미쓰에이", "JM02");
		File music = new File("D:\\프로젝트 자료\\src\\music_file\\미쓰에이 2집-Hush.wav");

		// 재생 음악 타이틀
		JLabel title = new JLabel(jm02.getT_song());
...
//		title.setForeground(Color.WHITE);
		...
		ImageIcon playPause_pic = new ImageIcon(JM02.class.getResource("../image_files/playpause.png"));
		...
		ImageIcon pause_pic = new ImageIcon(JM02.class.getResource("../image_files/stop.png"));
		...
		volume.setBackground(MainPage.missa_color);
		...
		ImageIcon alb_pic = new ImageIcon(JM02.class.getResource("../image_files/Miss_2.jpg"));
		...
		JLabel team_name = new JLabel(jm02.getTeam_name());
...
//		team_name.setForeground(Color.WHITE);
		...
		JLabel alb_name = new JLabel(jm02.getAlb_name());
...
//		alb_name.setForeground(Color.WHITE);
		...
		JLabel song_cnt = new JLabel(String.format("%d", jm02.getSong_cnt()));
...
//		song_cnt.setForeground(Color.WHITE);
		...
		JLabel t_song = new JLabel(jm02.getT_song());
...
//		t_song.setForeground(Color.WHITE);
		...
		JLabel s_date = new JLabel(String.format("%s", jm02.getS_date()));
...
//		s_date.setForeground(Color.WHITE);
		...
		info.setLayout(null);
		info.setBackground(MainPage.missa_color);
