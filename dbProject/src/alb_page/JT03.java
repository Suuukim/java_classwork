...
public class JT03 extends JFrame {
	...
	private void init() {
		Album jt03 = AlbumDao.selectAlbum("TWICE", "JT03");
		File music = new File("D:\\프로젝트 자료\\src\\music_file\\TWICE 3집-SCIENTIST.wav");

		// 재생 음악 타이틀
		JLabel title = new JLabel(jt03.getT_song());
		title.setFont(new Font("맑은 고딕", Font.BOLD, 30));
//		title.setForeground(Color.WHITE);
		title.setBounds(625, 130, 400, 40);

		// 음악 재생&일시정지
		JButton playPause = new JButton();
		ImageIcon playPause_pic = new ImageIcon(JT03.class.getResource("../image_files/playpause.png"));
		...
		ImageIcon pause_pic = new ImageIcon(JT03.class.getResource("../image_files/stop.png"));
		...
		ImageIcon alb_pic = new ImageIcon(JT03.class.getResource("../image_files/twice_3.jpg"));
		...
		JLabel team_name = new JLabel(jt03.getTeam_name());
...
//		team_name.setForeground(Color.WHITE);
		...
		JLabel alb_name = new JLabel(jt03.getAlb_name());
...
//		alb_name.setForeground(Color.WHITE);
		...
		JLabel song_cnt = new JLabel(String.format("%d", jt03.getSong_cnt()));
...
//		song_cnt.setForeground(Color.WHITE);
		...
		JLabel t_song = new JLabel(jt03.getT_song());
...
//		t_song.setForeground(Color.WHITE);
		...
		JLabel s_date = new JLabel(String.format("%s", jt03.getS_date()));
