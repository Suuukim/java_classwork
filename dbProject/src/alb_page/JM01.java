...
public class JM01 extends JFrame {
	...
	private void init() {
		...
		File music = new File("D:\\프로젝트 자료\\src\\music_file\\미쓰에이 1집-Good-bye Baby.wav");
...
//		title.setForeground(Color.WHITE);
		...
		ImageIcon playPause_pic = new ImageIcon(JM01.class.getResource("../image_files/playpause.png"));
