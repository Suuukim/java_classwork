...
public class Itzy extends JFrame implements ActionListener{
...
//			("./background/aespa2.jpg").getImage();		//백그라운드 이미지 설정.
	...
	private void init() {
		laAE1 = new JLabel("ITZY");
		laAE1.setFont(new Font("Algerian",Font.BOLD,30));
		laAE1.setBounds(210, -100, 300, 280);
		
		btAE1 = new JButton();
		btAE1.setIcon(new ImageIcon("./group/ITZY.jpg"));
		btAE1.setBounds(0, 55, 500, 250);
