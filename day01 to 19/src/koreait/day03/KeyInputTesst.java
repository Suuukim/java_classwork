...
import java.util.Scanner;		// java.utill 패키지의 Scanner 클래스를 메모리에 로드합니다.
				// java.lang 기본패키지의 클래스들은 기본 클래스 -import 안 합니다.
public class KeyInputTesst {		// 키보드 입력으로 변수에 값을 저장하는 연습입니다.
...
//		import 필요합니다.
		Scanner sc = new Scanner(System.in);	// -> 지금은 외우세요.
...
//	 느낌으로 하는 미션... 실수를 입력 받아서 출력(소수점이하 4자리)
	
		double data1;
		System.out.print("\n실수값 1개 입력하세요. >>> ");
		data1 = sc.nextDouble();	// 입력된 값을 double로 변환 (nextDouble메소드)하고 data1 변수에 저장합니다.
