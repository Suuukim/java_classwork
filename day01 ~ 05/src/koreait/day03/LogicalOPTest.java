...
public class LogicalOPTest {  //논리연산을 연습합니다.
	...
	public static void main(String[] args) {
		...
		System.out.println(" true adn true = " + (true && true));
		System.out.println(" true adn false = " + (true && false));
		System.out.println(" false adn true = " + (false && true));
		System.out.println(" false adn false = " + (false && false));
