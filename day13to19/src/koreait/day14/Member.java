...
public class Member {
	...
	//객체지향프로그램의 특징 상속,은닉성
	//회원이 분양받습니다. 회원나이 강아지는 15세이상, 고양이는 18세이상, 토끼는 13세이상 분양 받을 수 있다.(처리조건)
	boolean isAdopt(Animal animal) {	//Animal 자식클래스 Puppy,Cat,Rabbit 객체가 animal 변수로 참조하게 됩니다.
	//현재 회원객체가 인자로 전달받은 animal 객체를 분양자격이 되는지 반환값을 결정한다.
