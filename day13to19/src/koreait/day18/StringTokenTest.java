...
public class StringTokenTest {
	...
	public static void main(String[] args) {
		...
		// 	-> 저장되어있는 문장열을 파일에서 읽기 하여 다시 StudentScore 객체로 생성한다면 
		//	-> 구분기호 공백을 기준으로 데이터를 분리(토큰화)합니다.	-> StringToken 클래스 메소드를 사용합니다.
		...
		//stk 객체는 hasMoreTokens()로 모든 토큰을 다 읽으면 더이상 읽을 토큰이 없을 때 거짓이 되어서 반복 종료
		...
		// \t\n\r\f : 공백, 탭, 줄바꿈(줄만), (-> 잘안쓰는 기호 : carriage return(커서를 맨앞으로), form feed)
