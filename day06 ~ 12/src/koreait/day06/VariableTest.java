...
//	final int test;		//final 변수는 꼭 초기값을 저장합니다.
	...
	public static void main(String[] args) {
		...
		int sum = 100;
		//1. while,for,if... { } 블로 안에서 선언된 변수 : 지역변 수
		//2. method { } 블록 안에 서 선언된 변수 : 지역변수
		
		while(true) {
			int k=12;
			System.out.println("k=" + k);
			if(k==12) break;
			System.out.println("sum=" + sum);	//main 메소드 { } 안에서 모두 사용가능
		}
		
//		System.out.println("k=" + k); 	// 오류 { } 지역을 벗어났습니다.
		System.out.println("전역변수gval="+gval);
	
		
		System.out.println("final 변수 fval2=" + fval2);
//		fval2=123;		// final 변수는 값을 변경 못합니다.
...
//		static final 예시
	...
	static void methodA(int a) {
		...
		System.out.println("전역변수gval="+gval);
//		nonStatic(123);		//오류
//		System.out.println(fval1);	//오류 같은 static 변수가 아니기 때문에
	}
	...
	void nonStatic(int a) {
		...
		System.out.println("--------------");
//		fval=100;			//fval 변수는 값을 변경할 수 없습니다.
	}
	
	//static -> static 만
	//nonstatic 에서는 static, nonstatic 둘다 사용, 	*nonstatic은 static 키워드가 없는 것.
}
