...
public class MathTest {
	...
	public static void main(String[] args) {
		...
		//예시 : 15는 약수 1,(3,5),15 소수x		, 11의 약수 1,11 -> 소수o
		//소수 판별 수식을 생각해봅시다.	정수 num이 소수일까?	2부터 num-1 까지 나누어서 나머지가 0인값이 있으면 소수아님.
		//		->* num이 15일때 2에서 14까지 나누어서 나머지가 0이 있는지?	->*** 실행속도를 줄이기 위해 2루트(제곱근) 값까지 나누기하면 됩니다.
		//		->** 제곱근 대신에 2부터 num/2(몫) 까지 나누어서 할수도 있습니다.
