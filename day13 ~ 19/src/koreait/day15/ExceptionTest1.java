...
public class ExceptionTest1 {
	...
	// Exception 요약 : 문법오류 아닙니다.	실행하면서 발생하는 오류 입니다. (발생가능성을 고려해서 프로그래밍 해야 합니다.)
...
//	int b = Integer.parseInt("abc");//Integer.parseInt("123");	-> 정삭적으로 실행
	//정수로 변환할 수 없는 문자열 NumberFormatException이 발생합니다.
//	System.out.println("b=" + b);
	
	double c = Double.parseDouble("123,456,600,123");//Double.parseDouble("1234.567");	-> 정상적으로 실행
	...
	nums[5] = 100;		
	//실행했을 때 ArrayIndexOutOfBoundsException 이 발생합니다. -> 인덱스 0~4
