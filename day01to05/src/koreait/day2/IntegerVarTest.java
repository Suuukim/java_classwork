...
public class IntegerVarTest {	// 정수를 저장하는 변수 연습합니다.
	...
	// 	        변수는 프로그램이 실행되는 동안에 임시로 사용되는 메모리 공간입니다.
	//	        데이터가 저장된 메모리에 접근하기 위해서 변수명(식별자)을 부여합니다.
	//	        변수 선언한다 -> 변수명과 데이터 형식을 지정하는 것. -> 메모리에 공간을 부여합니다.
...
//	변수 선언 할 때에는 기본형 타입(primitive) 타입 사용
//	byte,short,int,long 소문자로 시작하는 것은 정수 데이터 타입을 표시하는 키워드

		// 선언된 변수에 데이터 저장 : 대입문 ( = 기호 사용)
//	n1=1997;		// 오류 : overflow (데이터가 넘친경우)
	n1=100;
	n2=30000;
//	n2=40000;		// 오류 : overflow (데이터가 넘친경우)
	n3=40000;	
//	n3=4000000000;		// 40억  오류 : overflow (데이터가 넘친경우)
...
//							// n2는 short 인데 사칙연산 결과는 4바이트로 입니다.
//	int result2;
